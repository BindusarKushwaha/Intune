...
############################################################################################
##
## Script to install the Cisco AnyConnect4071
## 
## VER 3.0.1
##
## Change Log
...
appname="AnyConnect"                                                        # The name of our App deployment script (also used for Octory monitor)
app="AnyConnect.app"                                                        # The actual name of our App once installed
logandmetadir="/Library/Logs/Microsoft/IntuneScripts/AnyConnect"             # The location of our logs and last updated data
processpath="/Applications/AnyConnect.app/Contents/MacOS/AnyConnect"      # The process name of the App we are installing
...
#sleep 20
#installer -applyChoiceChangesXML https://capgem.blob.core.windows.net/ciscoanyconnect/anyconnect_choicesCAP.xml -pkg https://capgem.blob.core.windows.net/ciscoanyconnect/AnyConnect4071.pkg -target /
...
function installPKG () {
	...
	installer -applyChoiceChangesXML "$tempdir"/anyconnect_choicesCAP.xml -pkg "$tempfile" -target /Applications
...
function installDMGPKG () {
    ...
    do
		...
		installer -applyChoiceChangesXML https://capgem.blob.core.windows.net/ciscoanyconnect/anyconnect_choicesCAP.xml -pkg "$tempfile" -target /Applications
